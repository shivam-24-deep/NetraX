// SHA-256 over actual artifact bytes, used for evidence-integrity
...
// Plain-JS SHA-256 (FIPS 180-4). crypto.subtle is undefined on insecure
// origins — e.g. a phone opening the plain-HTTP LAN link from the Send-to-NetraX
// QR code — so this keeps hashing (and therefore ingestion) working there.
